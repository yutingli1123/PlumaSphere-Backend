...
class ConfigServiceTest {
    ...
    @Nested
    @DisplayName("Get config logic")
    class GetTests {
        @Test
        @DisplayName("Should return config value when config exists")
        ...
        @Test
        @DisplayName("Should return only public configs")
        ...
        @Test
        @DisplayName("Should handle mixed public and private configs")
    ...
    @Nested
    @DisplayName("Set config logic")
    class SetTests {
        @Test
        @DisplayName("Should create new config when config does not exist")
        ...
        @Test
        @DisplayName("Should update existing config when config exists")
        ...
        @Test
        @DisplayName("Should not set initialized when already initialized")
        ...
        @Test
        @DisplayName("Should set initialized when not yet initialized")
        ...
        @Test
        @DisplayName("Should not modify immutable fields")
    ...
    @Nested
    @DisplayName("Version logic")
    class VersionTests {
        @Test
        @DisplayName("Should create version config when not exists")
        ...
        @Test
        @DisplayName("Should increment existing version")
        ...
        @Test
        @DisplayName("Should handle null version value")
    ...
    @Nested
    @DisplayName("Verification code logic")
    class VerificationCodeTests {
        @Test
        @DisplayName("Should return true when codes match")
        ...
        @Test
        @DisplayName("Should return false when codes do not match")
        ...
        @Test
        @DisplayName("Should throw exception when code not set in Redis")
