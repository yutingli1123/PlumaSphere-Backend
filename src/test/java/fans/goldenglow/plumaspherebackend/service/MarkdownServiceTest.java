...
class MarkdownServiceTest {
    ...
    @Nested
    @DisplayName("Plain Text Conversion")
    class PlainTextConversion {
        @Test
        @DisplayName("Should convert simple text")
        ...
        @Test
        @DisplayName("Should convert lists")
        ...
        @Test
        @DisplayName("Should convert line breaks")
        ...
        @Test
        @DisplayName("Should convert mixed content")
        ...
        @Test
        @DisplayName("Should convert strikethrough")
        ...
        @Test
        @DisplayName("Should convert multiple paragraphs")
